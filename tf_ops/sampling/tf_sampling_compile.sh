...
echo $TF_INC
g++ -std=c++11 tf_sampling.cpp tf_sampling_g.cu.o -o tf_sampling_so.so -shared -fPIC -I$TF_INC -I $EBROOTCUDA/include -I$TF_INC/external/nsync/public -L /usr/local/cuda-11.4/targets/x86_64-linux/lib -lcudart -L $EBROOTCUDA/lib64/ -L$TF_LIB -ltensorflow_framework -O2 -D_GLIBCXX_USE_CXX11_ABI=0
