...
def get_model(point_cloud, is_training, bn_decay=None):
    ...
    net = tf_util.conv2d(input_image, 64, [1,10], padding='VALID', stride=[1,1],
    ...
    points_feat1 = tf_util.conv2d(net, 512, [1,1], padding='VALID', stride=[1,1],
    ...
    pc_feat1 = tf_util.fully_connected(pc_feat1, 128, bn=True, is_training=is_training, scope='fc1', bn_decay=bn_decay)
    pc_feat1 = tf_util.fully_connected(pc_feat1, 64, bn=True, is_training=is_training, scope='fc2', bn_decay=bn_decay)
    print(pc_feat1)
