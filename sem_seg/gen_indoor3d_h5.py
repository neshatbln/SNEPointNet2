...
indoor3d_data_dir = os.path.join(data_dir, 'bridge_npy')
NUM_POINT = 12288
H5_BATCH_SIZE = 4000
...
output_dir = os.path.join(data_dir, 'bridge_npy_hdf5_data')
...
for i, data_label_filename in enumerate(data_label_files):
    ...
    data, label = indoor3d_util.room2blocks_wrapper_normalized(data_label_filename, NUM_POINT, block_size=0.20, stride=0.10, random_sample=False, sample_num=None)   #MAJID 0.4 & 0.4
